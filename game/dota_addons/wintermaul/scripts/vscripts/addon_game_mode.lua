...
function Precache( context )
	...
	PrecacheUnitByNameSync("storm_caller",context)
	PrecacheUnitByNameSync("chain_lightning_caster",context)
	PrecacheUnitByNameSync("thunder_rod",context)
	PrecacheUnitByNameSync("sparkler",context)
	PrecacheUnitByNameSync("battery",context)
